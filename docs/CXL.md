...
Both examples are runnable from [`examples/cxl/`](../examples/cxl/) in
the repo.
...
| --- | --- |
| Try CXL right now | [`examples/cxl/`](../examples/cxl/) |
| One-page CX syntax reference | [`docs/CHEATSHEET.md`](CHEATSHEET.md) |
| Full normative spec | [`spec/cxl.md`](../spec/cxl.md) |
