...
(function () {
  ...
  const program = {
    ...
    "106-cxpath-last": {
      ...
      input: "[?let [= $doc [list [item id=1] [item id=2] [item id=3]]] $doc/item[= $_position $_last]]",
    ...
    "107-cxpath-compound": {
      ...
      input: "[?let [= $doc [users [user active=true age=30] [user active=false age=40] [user active=true age=22]]] $doc/user[and [= $_@active true] [> $_@age 25]]]",
    ...
    "121-composite-predicate": {
      ...
      input: "[?let [= $doc [users [user active=true age=30 role=admin] [user active=true age=22 role=user] [user active=false age=40 role=admin]]] $doc/user[and [= $_@active true] [>= $_@age 25]]]",
    ...
    "123-count-matches": {
      ...
      input: "[?let [= $doc [log [hit ok=true] [hit ok=false] [hit ok=true] [hit ok=true]]] [$count $doc/hit[= $_@ok true]]]",
    ...
    "132-pipe-of-modifies": {
      ...
      input: "[?let [= $doc [users [user id=1 banned=true] [user id=2 banned=false] [user id=3 banned=true]]] [?pipe $doc [?modify //user[= $_@banned true] [delete]] [?modify //user [set-attr role \"member\"]]]]",
    ...
    "137-query-by-subject": {
      ...
      input: "[?let [= $g [triples [t s=Alice p=knows o=Bob] [t s=Alice p=likes o=pizza] [t s=Bob p=likes o=tea]]] $g//t[= $_@s \"Alice\"]]",
    ...
    "138-query-by-predicate": {
      ...
      input: "[?let [= $g [triples [t s=A p=knows o=B] [t s=B p=knows o=C] [t s=A p=likes o=X]]] $g//t[= $_@p \"knows\"]]",
    ...
    "139-out-edges": {
      ...
      input: "[?let [= $g [triples [t s=A p=r1 o=B] [t s=A p=r2 o=C] [t s=B p=r1 o=D]]] [?for [in $t $g//t[= $_@s \"A\"]] [yield [edge to=$t/@o via=$t/@p]]]]",
    ...
    "140-in-edges": {
      ...
      input: "[?let [= $g [triples [t s=A p=r1 o=B] [t s=C p=r1 o=B] [t s=A p=r2 o=D]]] [?for [in $t $g//t[= $_@o \"B\"]] [yield [edge from=$t/@s via=$t/@p]]]]",
    ...
    "141-reachability-1hop": {
      ...
      input: "[?let [= $g [triples [t s=A p=knows o=B] [t s=A p=knows o=C] [t s=B p=knows o=D]]] [?for [in $t $g//t[and [= $_@s \"A\"] [= $_@p \"knows\"]]] [yield $t/@o]]]",
