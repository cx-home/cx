...
Companion to `lang/python/test_v0_8_0_surfaces.py` (which covers the
...
Run from the repo root:
    ...
    cd lang/python && python3 -m unittest test_v0_8_0_surface
"""
...
# Allow `python3 -m unittest test_v0_8_0_surface` from lang/python/.
