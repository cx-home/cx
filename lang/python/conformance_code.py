...
SUPPORTED_FIXTURES = (
    ...
    'sap-else-01-err-defaults',
    'sap-else-02-empty-defaults',
    'sap-else-03-null-passes',
    'sap-else-04-false-passes',
    'sap-else-05-zero-passes',
    'sap-else-06-emptystr-passes',
    'sap-else-07-emptyarray-passes',
    'sap-else-08-emptymap-passes',
    'sap-else-09-invalid-passes',
    'sap-else-10-value-passes',
    'sap-else-11-lazy-default',
    # §8.2 [?match] bind-first + inline scrutinee.
    'sap-match-01-catch-bindfirst',
    'sap-match-02-inline-scrutinee',
    # O1 uniform pattern grammar (§5.2 Applicability Matrix cells).
    'sap-O1-00-wildcard',
    'sap-O1-01-attr-predicate',
    'sap-O1-01p-attr-plain-equality',
    'sap-O1-01b-attr-capture',
    'sap-O1-02-map-literal',
    'sap-O1-02b-map-capture',
    'sap-O1-02c-map-rest',
    'sap-O1-03-seq-closed',
    'sap-O1-03b-seq-spread',
    'sap-O1-04-array-literal',
    'sap-O1-04b-array-rest',
    'sap-O1-05-typetest-int',
    'sap-O1-06-typetest-anon-str',
    'sap-O1-07-typetest-float',
    'sap-O1-08-typetest-bool',
    'sap-O1-09-typetest-null',
    'sap-O1-10-typetest-atom',
    'sap-O1-11-attr-type-test',
    'sap-O1-12-scalar-spread-nonmatch',
    # O4 path-step distribution over a sequence.
    'sap-O4-01-path-over-seq',
    'sap-O4-02-empty-in-empty-out',
    'sap-O4-03-missing-attr-skipped',
    'sap-O4-04-nonelement-skipped',
    # O2 [?fallback] binds $err in [recover-with].
    'sap-O2-01-fallback-binds-err',
    # §9.6 [?with-error-hook] observe/enrich + O3 sugar.
    'sap-hook-01-observe-fires-at-raise-before-recovery',
    'sap-hook-02-O3-sugar-equivalence',
    'sap-hook-03-enrich-derived-err-propagates',
    'sap-hook-04-observe-silent-on-success',
    # §8.9 [?pipe] reshape (bare stages, tap, railway short-circuit, negatives).
    'sap-pipe-01-bare-stages',
    'sap-pipe-02-absence-continues',
    'sap-pipe-03-infix-removed',
    'sap-pipe-04-through-removed',
    'sap-pipe-05-noncallable-stage',
    'sap-pipe-06-tap-passes',
    'sap-pipe-07-tap-error-survives',
    'sap-pipe-08-skip-on-err',
    'sap-pipe-09-tap-skipped-after-err',
    # §2.5 try/catch/on-error retirement (negatives + equivalence).
    'sap-try-01-removed-negative',
    'sap-try-02-on-error-removed-negative',
    'sap-try-03-onerror-equiv-match',
    'sap-catch-01-arith',
    'sap-catch-02-unbound',
    # §1.0 null-totality (clean value or clean err, never a crash).
    'sap-null-01-arith-clean-err',
    'sap-null-02-concat-value',
    'sap-null-03-eq',
    'sap-null-04-count',
    'sap-null-05-first',
    # §10.5.7 concurrency: cancel-revokes-caps + RAII over handles + precedence.
    'sap-cancel-01-checkcancel-after-cancel',
    'sap-raii-01-with-open-future',
    'sap-raii-02-with-open-worker',
    'sap-revoke-01-cap-revoked-after-cancel',
    'sap-revoke-02-cancel-before-cap-precedence',
)
