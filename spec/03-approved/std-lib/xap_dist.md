# `$xap:pkg-*` — feature distribution & market (catalogue entry)
...
Catalogue entry for the `xap_dist_stdlib_builtin` dispatch family — the
...
stdlib-catalogue-gate reads module-meta blocks from
